...
function displayResults() {
    ...
    setTimeout(function () {
        ...
        if (typeBCount >= typeACount && typeBCount >= typeCCount && typeBCount >= typeDCount) {
            ...
            personalityExplanation = "It appears that pursuing a career in software engineering may not align perfectly with your natural traits and preferences. While this doesn't completely rule out the possibility of entering the field, it's important to consider whether this path truly resonates with your interests and characteristics. Keep in mind that anything is possible and hard work always trumps natural talent."
            personalityExplanation1 = "There are proven cases of people who didn't even own a computer, had absolutely zero skills in tech, signed up for a 3-month coding bootcamp and <span class='italic-text'>eventually</span> became successful software engineers. But you better believe that path was a hard one, full of stress and hardships. The final outcome will always be worth it though, when you're making a six-figure salary after just a few years in the industry!";
        }
